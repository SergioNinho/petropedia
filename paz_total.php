...
<body>
	<header>
		<div class="int">
 		...
 		<div class="header1">
 			<h3>Cuando los recursos son de otros y no importa la relación costo/beneficio, eso es DESPILFARRO.</h3>
 			<h3> Justificar necesidades inventadas lleva al MAL-GASTAR de los dineros de los ciudadanos.</h3>
 		</div>
	</header>
	<main>
		<div class="header_main">
			<img src="imagenes/despilfarros_heard.png">
		</div>
		<div class="title">
			<h1>Principales noticias sobre paz total</h1>
			<img src="imagenes/nepotismo_img.png">
		</div>
		<?php
		$conectar= coneet();
		$consulta = $conectar->query("SELECT * from paz_total " );
