...
<body>
	<header>
		<div class="int">
 		...
 		<div class="header1">
 			<h3>Pràcticas escandalosas, ilegales, poco èticas y corruptas.</h3>
 			<h3>Aunque se niegue mil veces, la verdad siempre sale a la luz.</h3>
 		</div>
	</header>
	<main>
		...
		<div class="title">
			<h1>Principales noticias sobre escándalos</h1>
			<img src="imagenes/nepotismo_img.png">
		</div>
		<?php
		$conectar= coneet();
		$consulta = $conectar->query("SELECT * from escandalo ORDER BY id DESC" );
