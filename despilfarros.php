...
<body>
	<header>
		<div class="int">
 		...
 		<div class="header1">
 			<h3>El DESPILFARRO, la MALVERSACIÓN, los FRAUDES, la FALTA DE EJECUCIÓN presupuestal, la CORRUPCIÓN, y otros, han ocasionado un grave DETRIMENTO PATRIMONIAL al país. </h3>
 			<!-- <h3> Justificar necesidades inventadas lleva al MAL-GASTAR de los dineros de los ciudadanos.</h3> -->
 		</div>
	</header>
	<main>
		<div class="header_main">
			<img src="imagenes/despilfarro.jpg">
		</div>
		<div class="title">
			<h1>Principales noticias sobre presuntos casos de despilfarros</h1>
			<img src="imagenes/despilfarros_img.png">
		</div>
		<?php
		$conectar= coneet();
		$consulta = $conectar->query("SELECT * from despilfarros ORDER BY id DESC" );
		...
		<div class="cont">
			...
			<div class="iframe" id="<?php echo $mostrar['id'].'n' ; ?>">
				<div class="iframe_cerrar">
					<h2 id="<?php echo $mostrar['id'].'cn';?>"><?php echo $mostrar['id'].'imagen';?></h2>
				</div>
