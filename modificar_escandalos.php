...
<head>
	...
	<title>Modificar escandalo</title>
</head>
<body>
	<header>
		<div class="int"></div>
		...
		<div class="admin">
			...
			<div class="form">
				...
				while ($mostrar_escandalos=mysqli_fetch_array($consulta_escandalos)) {
					if ($mostrar_escandalos['id']==$id_escandalos) {
					// code...
				?>
				<form action="modificar_escandalos1.php" method="POST" enctype="multipart/form-data">
					<input type="hidden" name="id" value="<?php echo $mostrar_escandalos['id']; ?> ">
					<label>ACCIÓN</label>
					<input type="text" name="accion" required value="<?php echo $mostrar_escandalos['accion']; ?> ">
					<label>DESCRIPCIÓN</label>
					<input type="text" name="descripcion" required value="<?php echo $mostrar_escandalos['descripcion']; ?>">
					<label>NOTICIA</label>
					<input type="text" name="noticia" required value="<?php echo $mostrar_escandalos['noticia']; ?>">
					<label>MEDIO</label>					
